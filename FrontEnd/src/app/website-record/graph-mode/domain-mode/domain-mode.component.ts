...
export class DomainModeComponent implements OnInit, OnDestroy {
  ...
  */
  ...
  DomainFilter() {
    for (let selectedNode of this.selectedNode.values()) {
      console.log("selected node: ", selectedNode);
      console.log("selected node domain: ", selectedNode.domain);
      
      const nodes = this.data.nodes.filter(node => node.domain === selectedNode.domain);
      console.log("After domain filtering: ", nodes);
      this.data.nodes = nodes;
    }
    this.CreateDomainLinks()
  }
